...
export default async function Faqsection() {
  ...
  return (
    ...
    <div className="space-y-4 text-white/90">
      <details className="rounded-lg border border-2 border-gray-700 hover:border-blue-500 bg-gray-900 p-4 hover:scale-105 hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-200">
        <summary className="cursor-pointer font-medium">{t('q1')}</summary>
        <p className="mt-2 text-white/70">{t('a1')}</p>
      </details>
      <details className="rounded-lg border-2 border border-gray-700 hover:border-blue-500 bg-gray-900 p-4 hover:scale-105 hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-200">
